package com.dangdang.ddframe.rdb.sharding.example.transaction.yunai;
...
public class YunaiMain {
    ...
    private static DataSource createDataSource(final String dataSourceName) {
        ...
        result.setUrl(String.format("jdbc:mysql://localhost:33061/%s", dataSourceName));
    ...
    private static DataSource createTransactionLogDataSource() {
        BasicDataSource result = new BasicDataSource();
        result.setDriverClassName(com.mysql.jdbc.Driver.class.getName());
        result.setUrl("jdbc:mysql://localhost:33061/trans_log");
        result.setUsername("root");
        result.setPassword("123456");
        return result;
    }
